...
\noindent Die Kapitel folgen dem DSR-Zyklus nach Peffers et al.:

\vspace{0.3em}
\begin{tabular}{@{}L{2cm} L{3.5cm} L{9cm}@{}}
  \textbf{Kap.\ 1--4} & Relevance Cycle      & Problem verstehen, Systemlandschaft erfassen \\
  \textbf{Kap.\ 5--7} & Rigor Cycle          & Anforderungen erheben, Lösungsoptionen identifizieren \& bewerten \\
  \textbf{Kap.\ 8--9} & Artefakt-Evaluation  & MVP umsetzen \& validieren \\
  \textbf{Kap.\ 10}   & ---                  & Fazit und Ausblick \\
\end{tabular}
...
Kap.\ 2.5 Entscheidungsmethoden im Software Engineering & Sachse-Feedback (21.04.): theoretische Basis für Kap.\ 7 \\
