...
\begin{tabular}{@{}L{7.5cm} L{8cm}@{}}
  ...
  {\small 4.3\enspace Ist-Zustand der KPI-Verfügbarkeit}        & {\small 9.1\enspace Ergebnisse der Bewertung} \\
...
No-Go: eigener Datalake / eigene Datenhaltung & Janine: Integration nur über vorhandene SAP-Systeme --- kein neues Speichersystem aufbauen \\
...
Analyse \& Modell & 25. Mai -- 14. Jun & Lösungsraum, Scoring-Modell + \textbf{erstes Review (Janine)} & Kap. 5, 6, 7 \\
