...
Die nachfolgenden Tabellen sind nicht als Lesetext konzipiert, sondern als maschinenlesbare Suchbefehle, die exakt so in die jeweiligen Literaturdatenbanken eingegeben wurden.
Ihre Dokumentation dient der Reproduzierbarkeit des Suchprozesses — eine Kernanforderung des Rigor~Cycle im zugrundeliegenden \gls{dsr}-Rahmen\vglcite[79]{hevner2004} — und ermöglicht eine unabhängige Nachvollziehung der Trefferbasis (vgl.\ Abschnitt~\ref{sec:literaturrecherche}).
...
% " ist in german babel ein aktives Zeichen ("O -> Ö etc.).
% \catcode`\"=12 macht es innerhalb dieser Gruppe zu einem gewöhnlichen
% Zeichen, damit die Anführungszeichen in den Suchstrings korrekt rendern.
